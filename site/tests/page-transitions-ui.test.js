...
assert.match(indexSource, /styles\.css\?v=269/, 'the dashboard must load the current shared styles');
assert.match(requestHtmlSource, /styles\.css\?v=269/, 'the request page must load the current shared transition styles');
