...
CREATE UNIQUE INDEX IF NOT EXISTS operational_events_source_ref_idx
  ON operational_events(source_record_type,source_record_id)
...
CREATE TABLE IF NOT EXISTS incidents (
  ...
  root_event_id BIGINT NOT NULL REFERENCES operational_events(id) ON DELETE RESTRICT,
  correlation_id VARCHAR(64) NOT NULL,
  created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
...
CREATE TABLE IF NOT EXISTS incident_events (
  ...
  operational_event_id BIGINT NOT NULL REFERENCES operational_events(id) ON DELETE RESTRICT,
