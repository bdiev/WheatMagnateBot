...
const DISCORD_CHAT_WEBHOOK_URL = process.env.DISCORD_CHAT_WEBHOOK_URL || '***REMOVED_DISCORD_WEBHOOK***'; // вставьте сюда новый вебхук или установите переменную окружения
// -----------------------------
