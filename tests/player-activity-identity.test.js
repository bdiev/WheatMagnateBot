...
async function run() {
  ...
  assert.match(botSource, /INSERT INTO game_chat_messages \(username, player_uuid, message, message_count, is_visible\)/, 'new chat messages must store the UUID and statistical visibility metadata');
