...
assert.match(indexSource, /app\.js\?v=147/, 'the updated chat behavior must use a fresh script URL');
assert.match(serviceWorkerSource, /CACHE_VERSION = '124'/, 'the app shell cache must be replaced after the UI update');
