...
assert.match(indexSource, /styles\.css\?v=243/, 'the updated mobile layout must use a fresh stylesheet URL');
assert.match(indexSource, /app\.js\?v=247/, 'the updated dashboard behavior must use a fresh script URL');
