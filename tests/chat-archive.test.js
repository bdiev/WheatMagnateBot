...
assert.match(indexSource, /app\.js\?v=162/, 'the updated dashboard behavior must use a fresh script URL');
assert.match(serviceWorkerSource, /CACHE_VERSION = '158'/, 'the app shell cache must be replaced after dashboard behavior changes');
