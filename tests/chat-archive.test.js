...
assert.match(indexSource, /styles\.css\?v=219/, 'the updated mobile layout must use a fresh stylesheet URL');
assert.match(indexSource, /app\.js\?v=219/, 'the updated dashboard behavior must use a fresh script URL');
