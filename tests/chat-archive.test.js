...
assert.match(indexSource, /app\.js\?v=252/, 'the updated dashboard behavior must use a fresh script URL');
assert.match(serviceWorkerSource, /CACHE_VERSION = '268'/, 'the app shell cache must be replaced after dashboard behavior changes');
