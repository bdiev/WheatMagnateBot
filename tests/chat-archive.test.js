...
assert.match(indexSource, /app\.js\?v=232/, 'the updated dashboard behavior must use a fresh script URL');
assert.match(serviceWorkerSource, /CACHE_VERSION = '239'/, 'the app shell cache must be replaced after dashboard behavior changes');
