...
assert.match(indexSource, /styles\.css\?v=245/, 'the updated mobile layout must use a fresh stylesheet URL');
assert.match(indexSource, /app\.js\?v=250/, 'the updated dashboard behavior must use a fresh script URL');
